# Operator Quickstart — cloud-itonami-isic-5590

Shortest path from clone to a verified local dry-run for **ISIC 5590** (`cloud-itonami-isic-5590`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5590.git
